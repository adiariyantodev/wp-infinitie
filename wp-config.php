...
//define( 'DB_NAME', 'mofamedi_infrm' );
//define( 'DB_NAME', 'hpfnhqos_infrm' );
define( 'DB_NAME', 'infiniti_infwp' ); //local

/** Database username */
//define( 'DB_USER', 'mofamedi_infwp' );
//define( 'DB_USER', 'hpfnhqos_adm' );
define( 'DB_USER', 'infiniti_wplive' ); //local

/** Database password */
//define( 'DB_PASSWORD', 'Sp!64.kv5q' );
//define( 'DB_PASSWORD', 'dbs_infinitie2024@' );
define( 'DB_PASSWORD', 'dbs_infinitie2024@' ); //local

/** Database hostname */
//define( 'DB_HOST', 'mars.epicdns.co.uk' ); 
//define( 'DB_HOST', 'ns2.mysecurecloudhost.com' ); 
